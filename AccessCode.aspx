...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row" style="background-color: #f1f7fd; border-radius: 10px; margin: 0px">
        ...
        <div class="col-md-5">
            ...
            <asp:TextBox name="txtPwd1" size="19" ID="txtPwd1" runat="server" CssClass="form-control" TextMode="Password" required></asp:TextBox><br />
            ...
            <label for="txtAccessCode">Company Code:</label>
