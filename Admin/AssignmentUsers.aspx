<%@ Page Title="" Language="C#" MasterPageFile="~/Basic.Master" AutoEventWireup="true" CodeBehind="AssignmentUsers.aspx.cs" Inherits="NXLevel.LMS.Admin.AssignmentUsers" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        function onSave() {
            Utils.Post("AssignmentUsers.aspx/SaveUsers",
                {
